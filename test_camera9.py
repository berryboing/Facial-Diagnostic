...
# ==========================================
# 5. USER INTERFACE (TKINTER) - Squeezed for RPi LCD
# ==========================================
def show_results_ui(dep_score, anx_score, str_score, dep_text, anx_text, str_text, captured_frame):
    ...
    # Squeezed the height from 600 down to 450 to fit standard RPi screens
    root.geometry("650x450") 
    root.configure(bg="#FFFFFF") 

    # Slightly reduced font sizes to save vertical space
    ...
    # Reduced pady (vertical padding) drastically across the board
